...
@Component({
  selector: 'app-survey2-ready-survey-not-necessary',
  templateUrl: './survey2-ready-survey-not-necessary.component.html',
  styleUrls: ['./survey2-ready-survey-not-necessary.component.scss']
})
export class Survey2ReadySurveyNotNecessaryComponent implements OnInit {
  @Input() reports: any;
  @Input() btity: any;
  ...
  calculateProcessedReport() {
    const report = this.reports['resultIsSurveyNotNecessaryVehicles'];
