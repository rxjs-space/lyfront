...
@Component({
  selector: 'app-survey2-ready2-two-surveys',
  templateUrl: './survey2-ready2-two-surveys.component.html',
  styleUrls: ['./survey2-ready2-two-surveys.component.scss']
})
export class Survey2Ready2TwoSurveysComponent implements OnInit {
  @Input() reports: any;
  @Input() btity: any;
  ...
  calculateProcessedReport(filterValue) {
    const report = this.reports['resultSurveyReadyTwoSurveys'];
